 ...
 *
 */
public class URIDecodingFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        noDecodeList.add("/V1/console/image"); // upload image file
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
        ...
        if (isNoDecodeList(req.getServletPath())) {
            ...
            URIHttpServletRequestWrapper DecodingRequest = new URIHttpServletRequestWrapper(req);
